<div class="modal fade" id="editModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?= form_open('faq/update', ['class' => 'formUpdate'], ['id' => $faq['id']]); ?>
			<div class="modal-body">
				<div class="form-group">
					<label for="pertanyaan" class="form-label">Jenis Dokumen</label>
					<input class="form-control form-control-lg" id="pertanyaan" name="pertanyaan" value="<?= $faq['pertanyaan'] ?>">
					<div class="errornamajenis invalid-feedback">
						<span class="errorPertanyaan"></span>
					</div>
				</div>
                <div class="form-group">
					<label for="jawaban" class="form-label">Jawaban</label>
					<textarea class="form-control" id="jawaban" name="jawaban" rows="5"><?= $faq['jawaban']; ?></textarea>
