...
<div class="card ">
    ...
    <div class="card-body">
        <?= form_open_multipart('/sedekah/save', 'class="#"'); ?>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="rupiah" name="rupiah" value="<?= old('rupiah'); ?>">
            </div>
        </div>
        <div class="row mb-3">
        ...
        <button type="submit" class="btn btn-primary mb-3"><i class="mdi mdi-content-save"></i> Simpan</button>
        <?= form_close() ?>
    </div>
</div>
<?= $this->endSection(); ?>
